...
def sort_by_cohort(filename):
    ...
    #open file, named in var
    #for loop through each line in file
        #strip the line
        #words = list of split the line by pipes

        #save words[-1] to var person_type
        
        #for list in all_students:
            #if list[index][0:2] == person_type[0:2]:
                #add person to list
        
#####################
        #check if person_type is w si su f or g
            #check term
                #add words[0:2] to termlist
#######################
    ...
    for line in data_file:
        ...
        term = words[-1]
        student_name = words[0] + " " + words[1]

        if term == "Fall 2015":
            fall_15.append(student_name)
        elif term == "Winter 2016":
            winter_16.append(student_name)
        elif term == "Spring 2016":
            spring_16.append(student_name)
        elif term == "Summer 2016":
    ...
    #     for a_list in all_students:
    #         if a_list[0] == term[:2]:
    #             student_name = words[0] + " " + words[1]
    #             a_list.append(student_name)    
...
def hogwarts_by_house(filename):
    ...
    for line in data_file:
        ...
        #check if has house (words index of 2)
            #if yes, conditionals to check which house
                #add last_name (words index of 1) to associated house
        #else
            #conditionals to check for ghost vs instructor (words index of -1)
                #add last_name (words index of 1) to associated type
        house = words[2]
    ...
    #add all lists inside of all_hogwarts list
    ...
    #for loop to loop through each list within all_hogwarts list
        #apply sort method to each list
